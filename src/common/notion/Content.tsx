...
import 'react-notion-x/build/styles.css';                   // core styles shared by all of react-notion-x (required)
import 'react-notion-x/build/third-party/collection.css';   // used for collection views (optional)
import 'react-notion-x/build/third-party/equation.css';     // used for rendering equations (optional)
...
function Content({notionPage}: {notionPage: string}) {
    ...
    return <>
        ...
        <NotionRenderer
            ...
            fullPage={false}
            darkMode={false}
            components={{Code: LazyCode, Collection, Modal, Equation}} />
            : errors
